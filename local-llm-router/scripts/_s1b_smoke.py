#!/usr/bin/env python3
"""S1b smoke: A1–A5 / A6. No secrets printed."""
...
def main() -> None:
    ...
    post_messages("deepseek-v4-flash")
    print("=== A5 deepseek stream reject ===")
    _c5, raw5 = post_messages("deepseek-v4-flash", stream=True)
